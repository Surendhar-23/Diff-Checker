...
export const createAppTheme = (mode = 'dark') => {
  ...
  return createTheme({
    palette: {
      ...
      diff: {
        addedBg: isDark ? 'rgba(46, 160, 67, 0.16)' : '#e6ffec',
        addedText: isDark ? '#7ee787' : '#166534',
        addedWord: isDark ? 'rgba(46, 160, 67, 0.40)' : '#bbf7d0',
        deletedBg: isDark ? 'rgba(248, 81, 73, 0.16)' : '#ffebe9',
        deletedText: isDark ? '#ff7b72' : '#991b1b',
        deletedWord: isDark ? 'rgba(248, 81, 73, 0.40)' : '#fecaca',
        modifiedBg: isDark ? 'rgba(217, 119, 6, 0.16)' : '#fef3c7',
        modifiedText: isDark ? '#fbbf24' : '#92400e',
        gutterBg: isDark ? '#161b22' : '#f8fafc',
        gutterText: isDark ? '#6e7681' : '#64748b',
